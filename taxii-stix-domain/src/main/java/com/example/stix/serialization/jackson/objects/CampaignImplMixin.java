...
@JsonPropertyOrder({TYPE_PROPERTY, ID_PROPERTY, CREATED_BY_REF_PROPERTY, CREATED_PROPERTY, MODIFIED_PROPERTY,
        ...
        LAST_SEEN_PROPERTY, OBJECTIVE_PROPERTY})
public abstract class CampaignImplMixin {
    ...
    @JsonProperty(OBJECTIVE_PROPERTY) abstract String getObjective();

    @JsonCreator
    CampaignImplMixin(@JsonProperty(value = TYPE_PROPERTY, required = true) StixType type,
              ...
              @JsonProperty(OBJECTIVE_PROPERTY) String objective) {

...
import static com.example.stix.api.objects.AttackPattern.*;
...
public abstract class AttackPatternImplMixin {
    ...
    @JsonCreator
    AttackPatternImplMixin(@JsonProperty(value = TYPE_PROPERTY, required = true) StixType type,

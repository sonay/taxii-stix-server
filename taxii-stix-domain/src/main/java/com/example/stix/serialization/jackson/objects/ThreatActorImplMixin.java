...
@JsonPropertyOrder({TYPE_PROPERTY, ID_PROPERTY, CREATED_BY_REF_PROPERTY, CREATED_PROPERTY, MODIFIED_PROPERTY,
        REVOKED_PROPERTY, ThreatActor.LABELS_PROPERTY, EXTERNAL_REFERENCES_PROPERTY, OBJECT_MARKING_REFS_PROPERTY,
        GRANULAR_MARKINGS_PROPERTY, NAME_PROPERTY, DESCRIPTION_PROPERTY, ALIASES_PROPERTY, ROLES_PROPERTY,
        GOALS_PROPERTY, SOPHISTICATION_PROPERTY, RESOURCE_LEVEL_PROPERTY, PRIMARY_MOTIVATION_PROPERTY,
        SECONDARY_MOTIVATIONS_PROPERTY, PERSONAL_MOTIVATIONS_PROPERTY})
public abstract class ThreatActorImplMixin {
    ...
    @JsonProperty(ThreatActor.LABELS_PROPERTY) abstract List<String> getLabels();
    ...
    @JsonProperty(ROLES_PROPERTY) abstract List<String> getRoles();

    @JsonProperty(GOALS_PROPERTY) abstract List<String> getGoals();

    @JsonProperty(SOPHISTICATION_PROPERTY) abstract String getSophistication();
    ...
    @JsonProperty(PERSONAL_MOTIVATIONS_PROPERTY) abstract List<String> getPersonalMotivations();

    @JsonCreator
    ThreatActorImplMixin(@JsonProperty(value = TYPE_PROPERTY, required = true) StixType type,
            ...
            @JsonProperty(value = ThreatActor.LABELS_PROPERTY, required = true) List<String> labels,
            ...
            @JsonProperty(SOPHISTICATION_PROPERTY) String sophistication,
            @JsonProperty(PERSONAL_MOTIVATIONS_PROPERTY) List<String> personalMotivations,
            @JsonProperty(RESOURCE_LEVEL_PROPERTY) String resourceLevel,
            @JsonProperty(ROLES_PROPERTY) List<String> roles,
